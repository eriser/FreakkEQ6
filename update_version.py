...
def main():
  ...
  plistpath = scriptpath + "/resources/FreakkWah-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkWah-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkWah-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkWah-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkWah-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkWah-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/FreakkWah-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/FreakkWah.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FreakkWah.iss",inplace=1):
