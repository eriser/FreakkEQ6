...
def main():
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkEQ6-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/FreakkEQ6-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/FreakkEQ6.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FreakkEQ6.iss",inplace=1):
